/*****************************************************
     ...
     cstring.h - ANSI-C++ library: strings header
 ----------------------------------------------------
...
StrRep*     Salloc(StrRep*, const char*_LIBDEF_FAR_CPP_PTR, int, int);
StrRep*     Scopy(StrRep*, const StrRep*);
StrRep*     Scat(StrRep*, const char*_LIBDEF_FAR_CPP_PTR, int, const char*_LIBDEF_FAR_CPP_PTR, int);
StrRep*     Scat(StrRep*, const char*_LIBDEF_FAR_CPP_PTR, int,const char*_LIBDEF_FAR_CPP_PTR,int, const char*_LIBDEF_FAR_CPP_PTR,int);
StrRep*     Sprepend(StrRep*, const char*_LIBDEF_FAR_CPP_PTR, int);
...
protected:
  ...
  void              assign(const StrRep*, const char*_LIBDEF_FAR_CPP_PTR, int = -1);
...
// created via String operations
  ...
  SubString&        operator =  (const char*_LIBDEF_FAR_CPP_PTR t);
...
// return 1 if target appears anywhere in SubString; else 0
  ...
  int               contains(const char*_LIBDEF_FAR_CPP_PTR t) const;
...
// status
  ...
  int               empty() const;
  const char*_LIBDEF_FAR_CPP_PTR       chars() const;
...
// some helper functions
  int               search(int, int, const char*_LIBDEF_FAR_CPP_PTR, int = -1) const;
  int               search(int, int, char) const;
  int               match(int, int, int, const char*_LIBDEF_FAR_CPP_PTR, int = -1) const;
  int               _gsub(const char*_LIBDEF_FAR_CPP_PTR, int, const char*_LIBDEF_FAR_CPP_PTR ,int);
  int               _gsub(const Regex&, const char*_LIBDEF_FAR_CPP_PTR, int);
...
// constructors & assignment
                    ...
                    String(const char*_LIBDEF_FAR_CPP_PTR t);
                    String(const char*_LIBDEF_FAR_CPP_PTR t, int len);
                    String(char c);

                    ~String();

  String&           operator =  (const String&     y);
  String&           operator =  (const char*_LIBDEF_FAR_CPP_PTR y);
...
// concatenation
  ...
  String&           operator += (const String&     y); 
  String&           operator += (const SubString&  y);
  String&           operator += (const char*_LIBDEF_FAR_CPP_PTR t);
  String&           operator += (char        c);

  void              prepend(const String&     y); 
  void              prepend(const SubString&  y);
  void              prepend(const char*_LIBDEF_FAR_CPP_PTR t);
  void              prepend(char        c);
...
// concatenate first 2 args, store result in last arg
  ...
  friend inline void     cat(const String&, const char*_LIBDEF_FAR_CPP_PTR, String&);
  ...
  friend inline void     cat(const SubString&, const char*_LIBDEF_FAR_CPP_PTR, String&);
  friend inline void     cat(const SubString&, char, String&);

  friend inline void     cat(const char*_LIBDEF_FAR_CPP_PTR, const String&, String&);
  friend inline void     cat(const char*_LIBDEF_FAR_CPP_PTR, const SubString&, String&);
  friend inline void     cat(const char*_LIBDEF_FAR_CPP_PTR, const char*_LIBDEF_FAR_CPP_PTR, String&);
  friend inline void     cat(const char*_LIBDEF_FAR_CPP_PTR, char, String&);
...
// Concatenate first 3 args, store in last arg
  ...
  friend inline void     cat(const String&,const String&, const char*_LIBDEF_FAR_CPP_PTR, String&);
  ...
  friend inline void     cat(const String&,const SubString&, const char*_LIBDEF_FAR_CPP_PTR, String&);
  friend inline void     cat(const String&,const SubString&, char, String&);
  friend inline void     cat(const String&,const char*_LIBDEF_FAR_CPP_PTR, const String&,    String&);
  friend inline void     cat(const String&,const char*_LIBDEF_FAR_CPP_PTR, const SubString&, String&);
  friend inline void     cat(const String&,const char*_LIBDEF_FAR_CPP_PTR, const char*_LIBDEF_FAR_CPP_PTR, String&);
  friend inline void     cat(const String&,const char*_LIBDEF_FAR_CPP_PTR, char, String&);

  friend inline void     cat(const char*_LIBDEF_FAR_CPP_PTR, const String&, const String&,String&);
  friend inline void     cat(const char*_LIBDEF_FAR_CPP_PTR,const String&,const SubString&,String&);
  friend inline void     cat(const char*_LIBDEF_FAR_CPP_PTR,const String&, const char*_LIBDEF_FAR_CPP_PTR, String&);
  friend inline void     cat(const char*_LIBDEF_FAR_CPP_PTR,const String&, char, String&);
  friend inline void     cat(const char*_LIBDEF_FAR_CPP_PTR,const SubString&,const String&,String&);
  friend inline void     cat(const char*_LIBDEF_FAR_CPP_PTR,const SubString&,const SubString&,String&);
  friend inline void     cat(const char*_LIBDEF_FAR_CPP_PTR,const SubString&, const char*_LIBDEF_FAR_CPP_PTR, String&);
  friend inline void     cat(const char*_LIBDEF_FAR_CPP_PTR,const SubString&, char, String&);
  friend inline void     cat(const char*_LIBDEF_FAR_CPP_PTR,const char*_LIBDEF_FAR_CPP_PTR, const String&,    String&);
  friend inline void     cat(const char*_LIBDEF_FAR_CPP_PTR,const char*_LIBDEF_FAR_CPP_PTR, const SubString&, String&);
  friend inline void     cat(const char*_LIBDEF_FAR_CPP_PTR,const char*_LIBDEF_FAR_CPP_PTR, const char*_LIBDEF_FAR_CPP_PTR, String&);
  friend inline void     cat(const char*_LIBDEF_FAR_CPP_PTR,const char*_LIBDEF_FAR_CPP_PTR, char, String&);
...
// return position of target in string or -1 for failure
  ...
  int               index(const char*_LIBDEF_FAR_CPP_PTR t, int startpos = 0) const;  
...
// (or before, if pos is negative) in String; else 0
  ...
  int               contains(const char*_LIBDEF_FAR_CPP_PTR t, int pos) const;
...
// return 1 if target appears at position pos in String; else 0
  ...
  int               matches(const char*_LIBDEF_FAR_CPP_PTR t, int pos = 0) const;
...
//  return number of occurences of target in String
  ...
  int               freq(const char*_LIBDEF_FAR_CPP_PTR t) const;
...
// String through the SubString
  ...
  SubString         at(const char*_LIBDEF_FAR_CPP_PTR t, int startpos = 0);
  ...
  SubString         before(const char*_LIBDEF_FAR_CPP_PTR  t, int startpos = 0);
  ...
  SubString         through(const char*_LIBDEF_FAR_CPP_PTR  t, int startpos = 0);
  ...
  SubString         from(const char*_LIBDEF_FAR_CPP_PTR  t, int startpos = 0);
  ...
  SubString         after(const char*_LIBDEF_FAR_CPP_PTR t, int startpos = 0);
...
// delete the first occurrence of target after startpos
  ...
  void              del(const char*_LIBDEF_FAR_CPP_PTR t, int startpos = 0);
...
// global substitution: substitute all occurrences of pat with repl
  ...
  int               gsub(const char*_LIBDEF_FAR_CPP_PTR pat, const String&     repl);
  int               gsub(const char*_LIBDEF_FAR_CPP_PTR pat, const char*_LIBDEF_FAR_CPP_PTR repl);
...
// element extraction
  ...
  char&             operator [] (int i);
  const char&_LIBDEF_FAR_CPP_PTR  operator [] (int i) const;
  char              elem(int i) const;
  char              firstchar() const;
  char              lastchar() const;

// conversion
  operator const char*_LIBDEF_FAR_CPP_PTR() const;
  const char*_LIBDEF_FAR_CPP_PTR       chars() const;
...
// report current allocation (not length!)
  ...
  void     error(const char*_LIBDEF_FAR_CPP_PTR msg) const;
...
int        compare(const String&    x, const char*_LIBDEF_FAR_CPP_PTR y);
int        compare(const SubString& x, const String&     y);
int        compare(const SubString& x, const SubString&  y);
int        compare(const SubString& x, const char*_LIBDEF_FAR_CPP_PTR y);
...
inline const char*_LIBDEF_FAR_CPP_PTR String::chars() const { return &(rep->s[0]); }
...
inline const char*_LIBDEF_FAR_CPP_PTR SubString::chars() const { return &(S.rep->s[pos]); }
...
inline String::String(const String& x) 
  : rep(Scopy(0, x.rep)) {}
inline String::String(const char*_LIBDEF_FAR_CPP_PTR t) 
  : rep(Salloc(0, t, -1, -1)) {}
inline String::String(const char*_LIBDEF_FAR_CPP_PTR t, int tlen)
...
inline String& String::operator=(const char*_LIBDEF_FAR_CPP_PTR t)
{
...
inline SubString& SubString::operator = (const char*_LIBDEF_FAR_CPP_PTR ys)
{
  assign(0, ys);
  return *this;
}
...
inline void cat(const String& x, const char*_LIBDEF_FAR_CPP_PTR y, String& r)
{
...
inline void cat(const SubString& x, const char*_LIBDEF_FAR_CPP_PTR y, String& r)
{
  r.rep = Scat(r.rep, x.chars(), x.length(), y, -1);
}
...
inline void cat(const char*_LIBDEF_FAR_CPP_PTR x, const String& y, String& r)
{
  r.rep = Scat(r.rep, x, -1, y.chars(), y.length());
}

inline void cat(const char*_LIBDEF_FAR_CPP_PTR x, const SubString& y, String& r)
{
  r.rep = Scat(r.rep, x, -1, y.chars(), y.length());
}

inline void cat(const char*_LIBDEF_FAR_CPP_PTR x, const char*_LIBDEF_FAR_CPP_PTR y, String& r)
{
  r.rep = Scat(r.rep, x, -1, y, -1);
}

inline void cat(const char*_LIBDEF_FAR_CPP_PTR x, char y, String& r)
{
  r.rep = Scat(r.rep, x, -1, &y, 1);
}
...
inline void cat(const String& a, const String& x, const char*_LIBDEF_FAR_CPP_PTR y, String& r)
{
...
inline void cat(const String& a, const SubString& x, const char*_LIBDEF_FAR_CPP_PTR y, String& r)
{
  r.rep = Scat(r.rep, a.chars(), a.length(), x.chars(), x.length(), y, -1);
}
...
inline void cat(const String& a, const char*_LIBDEF_FAR_CPP_PTR x, const String& y, String& r)
{
  r.rep = Scat(r.rep, a.chars(), a.length(), x, -1, y.chars(), y.length());
}

inline void cat(const String& a, const char*_LIBDEF_FAR_CPP_PTR x, const SubString& y, String& r)
{
  r.rep = Scat(r.rep, a.chars(), a.length(), x, -1, y.chars(), y.length());
}

inline void cat(const String& a, const char*_LIBDEF_FAR_CPP_PTR x, const char*_LIBDEF_FAR_CPP_PTR y, String& r)
{
  r.rep = Scat(r.rep, a.chars(), a.length(), x, -1, y, -1);
}

inline void cat(const String& a, const char*_LIBDEF_FAR_CPP_PTR x, char y, String& r)
{
  r.rep = Scat(r.rep, a.chars(), a.length(), x, -1, &y, 1);
}


inline void cat(const char*_LIBDEF_FAR_CPP_PTR a, const String& x, const String& y, String& r)
{
  r.rep = Scat(r.rep, a, -1, x.chars(), x.length(), y.chars(), y.length());
}

inline void cat(const char*_LIBDEF_FAR_CPP_PTR a, const String& x, const SubString& y, String& r)
{
  r.rep = Scat(r.rep, a, -1, x.chars(), x.length(), y.chars(), y.length());
}

inline void cat(const char*_LIBDEF_FAR_CPP_PTR a, const String& x, const char*_LIBDEF_FAR_CPP_PTR y, String& r)
{
  r.rep = Scat(r.rep, a, -1, x.chars(), x.length(), y, -1);
}

inline void cat(const char*_LIBDEF_FAR_CPP_PTR a, const String& x, char y, String& r)
{
  r.rep = Scat(r.rep, a, -1, x.chars(), x.length(), &y, 1);
}

inline void cat(const char*_LIBDEF_FAR_CPP_PTR a, const SubString& x, const String& y, String& r)
{
  r.rep = Scat(r.rep, a, -1, x.chars(), x.length(), y.chars(), y.length());
}

inline void cat(const char*_LIBDEF_FAR_CPP_PTR a, const SubString& x, const SubString& y, String& r)
{
  r.rep = Scat(r.rep, a, -1, x.chars(), x.length(), y.chars(), y.length());
}

inline void cat(const char*_LIBDEF_FAR_CPP_PTR a, const SubString& x, const char*_LIBDEF_FAR_CPP_PTR y, String& r)
{
  r.rep = Scat(r.rep, a, -1, x.chars(), x.length(), y, -1);
}

inline void cat(const char*_LIBDEF_FAR_CPP_PTR a, const SubString& x, char y, String& r)
{
  r.rep = Scat(r.rep, a, -1, x.chars(), x.length(), &y, 1);
}

inline void cat(const char*_LIBDEF_FAR_CPP_PTR a, const char*_LIBDEF_FAR_CPP_PTR x, const String& y, String& r)
{
  r.rep = Scat(r.rep, a, -1, x, -1, y.chars(), y.length());
}

inline void cat(const char*_LIBDEF_FAR_CPP_PTR a, const char*_LIBDEF_FAR_CPP_PTR x, const SubString& y, String& r)
{
  r.rep = Scat(r.rep, a, -1, x, -1, y.chars(), y.length());
}

inline void cat(const char*_LIBDEF_FAR_CPP_PTR a, const char*_LIBDEF_FAR_CPP_PTR x, const char*_LIBDEF_FAR_CPP_PTR y, String& r)
{
  r.rep = Scat(r.rep, a, -1, x, -1, y, -1);
}

inline void cat(const char*_LIBDEF_FAR_CPP_PTR a, const char*_LIBDEF_FAR_CPP_PTR x, char y, String& r)
{
  r.rep = Scat(r.rep, a, -1, x, -1, &y, 1);
}
...
inline String& String::operator += (const char*_LIBDEF_FAR_CPP_PTR y)
{
  cat(*this, y, *this);
  return *this;
}
...
inline String operator + (const String& x, const char*_LIBDEF_FAR_CPP_PTR y) return r;
{
  cat(x, y, r);
}
...
inline String operator + (const SubString& x, const char*_LIBDEF_FAR_CPP_PTR y) return r;
{
  cat(x, y, r);
}
...
inline String operator + (const char*_LIBDEF_FAR_CPP_PTR x, const String& y) return r;
{
  cat(x, y, r);
}

inline String operator + (const char*_LIBDEF_FAR_CPP_PTR x, const SubString& y) return r;
{
  cat(x, y, r);
}
...
inline String operator + (const String& x, const char*_LIBDEF_FAR_CPP_PTR y) 
{
  String r;
  cat(x, y, r);
  return r;
...
inline String operator + (const SubString& x, const char*_LIBDEF_FAR_CPP_PTR y) 
{
  String r;
  cat(x, y, r);
  return r;
...
inline String operator + (const char*_LIBDEF_FAR_CPP_PTR x, const String& y) 
{
  String r;
  cat(x, y, r);
  return r;
...
inline String operator + (const char*_LIBDEF_FAR_CPP_PTR x, const SubString& y) 
{
  String r;
  cat(x, y, r);
  return r;
...
inline void String::prepend(const char*_LIBDEF_FAR_CPP_PTR y)
{
...
inline const char&_LIBDEF_FAR_CPP_PTR  String::operator [] (int i) const
{ 
  if (((unsigned)i) >= length()) error("invalid index");
  return rep->s[i];
}
...
inline int String::index(const char*_LIBDEF_FAR_CPP_PTR t, int startpos) const
{
...
inline int String::contains(const char*_LIBDEF_FAR_CPP_PTR t) const
{   
...
inline int String::contains(const char*_LIBDEF_FAR_CPP_PTR t, int p) const
{
...
inline int String::matches(const char*_LIBDEF_FAR_CPP_PTR t, int p) const
{
...
inline int SubString::contains(const char*_LIBDEF_FAR_CPP_PTR t) const
{
...
inline int String::gsub(const char*_LIBDEF_FAR_CPP_PTR pat, const String& r)
{
  return _gsub(pat, -1, r.chars(), r.length());
}

inline int String::gsub(const char*_LIBDEF_FAR_CPP_PTR pat, const char*_LIBDEF_FAR_CPP_PTR r)
{
...
inline int operator==(const String& x, const char*_LIBDEF_FAR_CPP_PTR t) 
{
...
inline int operator==(const SubString& x, const char*_LIBDEF_FAR_CPP_PTR t) 
{
  return compare(x, t) == 0; 
}
